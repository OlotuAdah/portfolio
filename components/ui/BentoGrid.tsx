...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-row-7 gap-4 lg:gap-8 mx-auto box-border sm:px-4 lg:px-0 ",
        className,
      )}
    >
      {children}
...
export const BentoGridItem = forwardRef<HTMLDivElement, {
  className?: string;
  id: number;
                ...
                <div className=" absolute inset-0 w-full h-full items-center">
                  <div className=" w-full h-full relative ">
                    <ChatBubble
                      ...
                      chatBubbleTrailClasses="absolute -right-4 -bottom-5 transform rotate-90 w-4  h-4 z-0 text-amber-500"
                      chatBubbleClasses="rounded-full rounded-br-none bg-amber-500 text-white px-12 py-3 z-10"
                    />

                    <ChatBubble
                      containerClasses="flex w-fit h-fit border-yellow-400 absolute bottom-0 -right-1"
                      chatBubbleTrailClasses="absolute -left-4 -top-6 transform -rotate-90 w-4  h-4 z-0 text-purple border-white/[0.2]"
                      chatBubbleClasses="rounded-full rounded-tl-none bg-purple border border-white/[0.2] px-12 py-3 z-10"
                    />
